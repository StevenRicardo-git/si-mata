    ...
    <div class="min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8 text-center">
            <div class="mb-8">
                ...
                <p class="mt-2 text-3xl font-bold text-gray-900 dark:text-gray-100">Halaman tidak ditemukan</p>
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Maaf, kami tidak dapat menemukan halaman yang Anda cari.</p>
            </div>
            <div class="mt-8">
                <a href="{{ url('/') }}"
