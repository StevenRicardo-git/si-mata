...
<body class="bg-gray-100 dark:bg-gray-900">
    <div class="min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8 text-center">
            <div class="mb-8">
                <h2 class="mt-6 text-6xl font-extrabold text-gray-900 dark:text-gray-100">503</h2>
                <p class="mt-2 text-3xl font-bold text-gray-900 dark:text-gray-100">Layanan Tidak Tersedia</p>
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Maaf, kami sedang melakukan pemeliharaan. Silakan coba lagi nanti.</p>
            </div>
            <div class="mt-8">
