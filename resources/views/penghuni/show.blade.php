            ...
            <form id="addKontrakForm" method="POST" action="{{ route('kontrak.store') }}">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="tanggal_sip" class="block text-sm font-medium text-gray-700 mb-2">Tanggal SIP <span class="text-red-500">*</span></label>
                            <input type="date" id="tanggal_sip" name="tanggal_sip" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary">
                        </div>
                        ...
                        <div>
                            <label for="tanggal_sps" class="block text-sm font-medium text-gray-700 mb-2">Tanggal SPS <span class="text-red-500">*</span></label>
                            <input type="date" id="tanggal_sps" name="tanggal_sps" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary">
                        </div>
